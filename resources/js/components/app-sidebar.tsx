...
import { BookText, CalendarClock, Calculator, LayoutGrid, Shield, Users, UserCheck, Settings2, FileImage, Globe, StickyNote } from 'lucide-react';
    ...
    switch (role) {
        ...
        default:
            return [
                ...
                { title: 'Notes', href: '/user/notes', icon: StickyNote },
